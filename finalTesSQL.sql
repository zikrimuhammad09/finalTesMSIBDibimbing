...
-- SELECT
--     post_date AS date,
--     EXTRACT(DAY FROM post_date) AS theDay,
--     TO_CHAR(post_date, 'Day') AS theDayName,
--     EXTRACT(WEEK FROM post_date) AS theWeek,
--     EXTRACT(MONTH FROM post_date) AS theMonth,
--     TO_CHAR(post_date, 'Month') AS theMonthName,
--     EXTRACT(YEAR FROM post_date) AS theYear
-- FROM
--     raw_posts;
